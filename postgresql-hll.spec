...
install -m644 hll--2.10.2.sql $RPM_BUILD_ROOT%{pgbaseinstdir}/share/extension
...
%{pgbaseinstdir}/share/extension/hll--2.10.2.sql

%{pgbaseinstdir}/lib/hll.so

%changelog
* Wed Dec 21 2016 Jarred Nicholls <jarred.nicholls@ironnetcybersecurity.com> - 2.10.2-0
- now supporting postgres 9.6
